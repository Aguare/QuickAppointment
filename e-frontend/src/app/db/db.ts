...
export const companies: Company[] = [
    {
      ...
      description: 'Barbería especializada en cortes de cabello y afeitado. Ambiente relajado y moderno',
    ...
    },
    {
      ...
      description: 'Barbería de lujo con servicio completo de cuidado personal masculino.',
    ...
    },
    {
      ...
      description: 'Clínica especializada en medicina general y servicios de urgencias.',
    ...
    },
    {
      ...
      description: 'Ofrecemos servicios dentales completos, desde limpiezas hasta tratamientos avanzados.',
    ...
    },
    {
      id: 5,
      name: 'FutbolManía',
      description: 'Alquiler de canchas deportivas para fútbol, basket y voleibol. Equipadas con iluminación nocturna.',
